# Affe / JSON-Render Notes

These notes were copied from `C:\Users\Patrick\gen2` as reference material for the Affe-style API work in `@doeixd/affe`.
...
- `ui-dialect-af-ui-json-render.md`: broader Affe authoring and JSON-Render serialization proposal from the Gen2 UI dialect notes.
