...
export class ViewSpecDecodeError extends Schema.TaggedError<ViewSpecDecodeError>(
...
export class ViewSpecInvalidError extends Schema.TaggedError<ViewSpecInvalidError>(
